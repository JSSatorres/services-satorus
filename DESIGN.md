...
- **Móvil en vertical:** el libro no va con el scroll. Ocupa una pantalla y el scroll no puede saltárselo: mientras se está por encima, lo que va después (preguntas, contacto, pie) no se pinta y la página termina en el libro; por debajo, no se pinta la portada y la página empieza en él (`setGate`, sin saltos visibles). Al llegar se fija: desde arriba por la portada, desde abajo por la última página. Cada gesto, por fuerte que sea, avanza una parada: una al final de cada página y, en «Tu lista de problemas», también al inicio. Las flechas pasan una página entera. El contador cuenta páginas (00 a 12). Se sale deslizando más allá de la primera o la última página, o con un enlace.
- **Móvil en horizontal:** con ~390 px de alto el texto de una página quedaría ilegible, así que en lugar del libro se ve el cuaderno cerrado girando y «Gira el móvil para leer el cuaderno»; el resto de la web funciona normal. Al volver a vertical el libro sigue en la página donde se estaba.
