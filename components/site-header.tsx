...
import { resumeCurtainTakeover, suspendCurtainTakeover } from "@/lib/curtain-nav";
...
function createSectionPreview(section: HTMLElement) {
  ...
  preview
    .querySelectorAll<HTMLElement>("a, button, input, select, summary, textarea")
    .forEach((element) => element.setAttribute("tabindex", "-1"));
  preview.querySelectorAll<HTMLElement>(".section-curtain-surface").forEach((surface) => {
