...
- **Móvil en vertical:** el libro no va con el scroll. Ocupa una pantalla y, en cuanto entra en ella (bajando o subiendo, por rápido que sea), se fija y bloquea el scroll: desde arriba abre por la portada, desde abajo por la última página. Cada página tiene dos paradas, al inicio y al final de su animación, y cada gesto (por fuerte que sea) lleva sólo a la siguiente: inicio → final → paso de página e inicio de la siguiente… Las flechas pasan una página entera y la dejan asentada. El contador cuenta páginas (00 a 12). Se sale deslizando más allá de la primera o la última página, o con un enlace.
