...
- **Móvil en vertical:** el libro no va con el scroll. Ocupa una pantalla y, en cuanto entra en ella (bajando o subiendo, por rápido que sea), se fija y bloquea el scroll: desde arriba abre por la portada, desde abajo por la última página. Cada gesto o botón pasa una sola página y el contador cuenta páginas (00 a 12). Se sale deslizando más allá de la primera o la última página, o con un enlace.
- **Móvil en horizontal:** no cabe una página legible; el libro se muestra plano (dobles páginas una tras otra) y vuelve al girar el móvil.
